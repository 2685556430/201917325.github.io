var config = {
    ...
    welcome: "青青子衿，悠悠我心<br>" +
             "但为君故，沉吟至今<br>" +
             "你好，我是梁鹤飞，华北水利水电大学软件工程大四在读生<br>" +
             "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>你好！我叫梁鹤飞，性别男，华北水利水电大学信息工程学院大四在读。我期望的工作岗位是C++/Java后端开发。</p>" +
    ...
    */  
     ...
     */
    portfolio: [
        ["./images/pro-1.png", "https://blog.csdn.net/m0_54069398?spm=1000.2115.3001.5343", "CSDN博客", "这里记录了我的学习笔记<br>持续更新"],
        ["./images/pro-2.png", "https://github.com/2685556430/Pan", "Pan网盘", "采用Java及相关技术栈实现的类网盘项目<br>2021/7/23"],
        ["https://pic3.zhimg.com/80/v2-d9766956d5c85c2780e4c5008fd946ca_1440w.jpg", "https://github.com/2685556430/DataStructure", "各种数据结构相关知识的代码实现", "C++实现"]
    ],
     ...
     */
    others: [
        ["2021-04-28", "第十二届蓝桥杯大学生B组省三等奖", "大二下学期，我参与第十二届蓝桥杯大学生B组，然比赛一改以往暴力题，半数以上DP，仅取得省级三等奖。"],
        ["2022-03-24", "第十三届蓝桥杯大学生B组省一等奖", "大三下学期，我参与第十三届蓝桥杯大学生B组，取得省级一等奖。"],
        ["2021-04-24", "第六届团队程序设计天梯赛团体国家三等奖", "大三下学期，我通过面向全年级的选拔，获得入队名额，跟随团队取得团体国家三等奖的成绩。"],
        ["2020-11-14", "2019级华北水利水电大学程序设计正式赛校级一等奖", "大二下学期，我参与校举办的面向全校程序设计大赛并获得一等奖，"]
    ],
